...
(async () => {
  ...
  await fs.writeFile("urea-and-electrolytes-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("urea-and-electrolytes-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
